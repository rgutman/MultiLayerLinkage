...
########################################################################################################################
########Implements CIBRL for the Simulation Setting with Error in Region,  Error in Area Income,  Error in Day of Birth
########################################################################################################################
...
for(t in 2:nsim){
  ...
  b=which(B==1,arr.ind=TRUE); b=b[order(b[,1]),]
  #Reset the linking matrix so it is empty
  C_flat = as.vector(C)
  ...
  for(s in 1:dim(B)[1]){
    ...
    ##################################################################################################
    # write.csv(theta_BM_Region,paste0("theta_BM_Region_CIBRL_R0_I0_D0_noD_",nrep,".csv"))
    # write.csv(theta_BM_Status,paste0("theta_BM_Status_CIBRL_R0_I0_D0_noD_",nrep,".csv"))
    # write.csv(theta_BM_Type,paste0("theta_BM_Type_CIBRL_R0_I0_D0_noD_",nrep,".csv"))
    # write.csv(theta_BM_SES,paste0("theta_BM_SES_CIBRL_R0_I0_D0_noD_",nrep,".csv"))
    # write.csv(theta_BM_Income,paste0("theta_BM_Income_CIBRL_R0_I0_D0_noD_",nrep,".csv"))
    # write.csv(theta_BU_Region,paste0("theta_BU_Region_CIBRL_R0_I0_D0_noD_",nrep,".csv"))
    # write.csv(theta_BU_Status,paste0("theta_BU_Status_CIBRL_R0_I0_D0_noD_",nrep,".csv"))
    # write.csv(theta_BU_Type,paste0("theta_BU_Type_CIBRL_R0_I0_D0_noD_",nrep,".csv"))
    # write.csv(theta_BU_SES,paste0("theta_BU_SES_CIBRL_R0_I0_D0_noD_",nrep,".csv"))
    # write.csv(theta_BU_Income,paste0("theta_BU_Income_CIBRL_R0_I0_D0_noD_",nrep,".csv"))
    # write.csv(theta_CM_DOB,paste0("theta_CM_DOB_CIBRL_R0_I0_D0_noD_",nrep,".csv"))
    # write.csv(theta_CM_Gender,paste0("theta_CM_Gender_CIBRL_R0_I0_D0_noD_",nrep,".csv"))
    # write.csv(theta_CU_DOB,paste0("theta_CU_DOB_CIBRL_R0_I0_D0_noD_",nrep,".csv"))
    # write.csv(theta_CU_Gender,paste0("theta_CU_Gender_CIBRL_R0_I0_D0_noD_",nrep,".csv"))
    # write.csv(BlockDesignation,paste0("BlockDesignation_CIBRL_R0_I0_D0_noD_",nrep,".csv"))
    # write.csv(LinkDesignation,paste0("LinkDesignation_CIBRL_R0_I0_D0_noD_",nrep,".csv"))
}
